...
require (
	github.com/aws/aws-sdk-go-v2 v1.42.0 // direct
	github.com/aws/aws-sdk-go-v2/config v1.32.26 // direct
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.42.4 // direct
